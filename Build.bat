...
NuGet.exe restore Rhetos.SimpleWindowsAuth.sln -NonInteractive || GOTO Error1
MSBuild.exe "Rhetos.SimpleWindowsAuth.sln" /target:rebuild /p:Configuration=Debug /verbosity:minimal /fileLogger || GOTO Error1
